...
export const CourseCard = ({ course }: Readonly<CourseCardProps>) => {
  ...
  return (
    <div
      key={course.id}
      className="flex gap-5 bg-gray-50 rounded-xl shadow-lg w-full max-h-80 2xl:w-96 2xl:min-h-96 cursor-pointer hover:shadow-2xl transition-all duration-300 ease-in-out"
    >
      <div className="flex justify-between h-full">
        <Image
          ...
          className="rounded-lg object-fill h-full shadow-xs"
        />
